...
public class CSC300Program4 {
	...
	public static int sumEvensRecursive (int[] a) {
		return sumEvensHelper(a, a.length);
	}
	
	public static int sumEvensHelper(int[] list, int n) {
		int result = 0;
		if(n == 0)
			return 0;
		if(list[n-1] % 2 == 0)
		 ...
		 return result + sumEvensHelper(list, n-1);
	}
	...
	public static void reverseRecursive (int[] a) {
	     reverseRecursiveHelper(a, a.length-1, 0);
	}
	
	public static int[] reverseRecursiveHelper(int[] list, int last, int first) {
		if(last == first)
			return list;
